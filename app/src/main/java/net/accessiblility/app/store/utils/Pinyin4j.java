...
public class Pinyin4j {
	...
	public static void main(String[] args) {
		...
		str = makeStringByStringSet(getPinyin(str));
		System.out.println("  end_time:" + System.currentTimeMillis());
		System.out.println(str);
		
		System.out.println("start_time:" + System.currentTimeMillis());
		str = getStringPinYin(str);
		System.out.println("  end_time:" + System.currentTimeMillis());
		System.out.println(str);
	}

	static public String getCharacterPinYin(char c) {
	...
	// 转换一个字符串
	static public String getStringPinYin(String str) {
