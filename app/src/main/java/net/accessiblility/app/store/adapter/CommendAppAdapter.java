 ...
 */
public class CommendAppAdapter extends BaseAdapter {

    private List<AppItemInfo.AppInfo> itemList;
    private ArrayList<LocalAppInfo> localAppList;
    private Context context;
    private TatansDb db;
    private static String TAG = "CommendAppAdapter";

    public CommendAppAdapter(Context context, List<AppItemInfo.AppInfo> list, ArrayList<LocalAppInfo> localAppList) {
        this.itemList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.appVersion.setText("版本号：" + itemList.get(position).getVersionName());
        ...
        holder.appDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (stateStr.equals("打开")) {
                    ...
                    File mFile = new File(DirPath.getMyCacheDir("stores/download/", appInfo.appName + ".apk"));
                    if (mFile.exists()) {
